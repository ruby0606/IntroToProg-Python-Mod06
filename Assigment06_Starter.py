...
# <Rabiya M Abdul>,<08.17.2020>,Modified code to complete assignment 6
# ---------------------------------------------------------------------------- #
...
strRmvTask = ""  # Captures the task the user wants to remove
    ...
    def remove_data_from_list(task, list_of_rows):
        ...
        for dicRow in list_of_rows:
            if dicRow["Task"] == strRmvTask:
                ...
                print("Specified task is removed")
                break
        else:
            print("Matching task not found. Please retry!")
        return list_of_rows, 'Success'

    @staticmethod
    def write_data_to_file(file_name, list_of_rows):
        # TODO: Add Code Here!
        file_name=open("ToDoFile.txt", "w")
        for dicRow in list_of_rows:
            file_name.write(str(dicRow["Task"]) + "," + str(dicRow["Priority"])+ "\n")
        file_name.close()
        print("Saved to file")
...
class IO:
    ...
    def input_task_to_remove():
        pass  # TODO: Add Code Here!
        strRmvTask= str(input("Enter the name of task that you wish to remove: "))
        return strRmvTask
        # return task
...
while(True):
    ...
    if strChoice.strip() == '1':  # Add a new Task
        ...
        # TODO: Add Code Here
        strRmvTask=IO.input_task_to_remove()
        Processor.remove_data_from_list(strRmvTask, lstTable)
        IO.input_press_to_continue(strStatus)
        continue  # to show the menu
